...
//
//  buckets
//    [Object] - object of buckets to get authorization from
//
...
// Static File
//
// return a readStreem of the static file
//
// Parameters
//  fileName
...
//
//  staticDir
//    [String] - static file directory
//
exports.staticFile = function (fileName, staticDir) {
  staticDir = staticDir || __dirname + '/../dist';
  var absolute = (fileName.indexOf('/') === 0) ? fileName : (staticDir + '/' + fileName);
  var file = fs.createReadStream(absolute);
  if (!file) {
